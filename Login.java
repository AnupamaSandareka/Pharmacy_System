...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        ...
        getContentPane().setBackground(new java.awt.Color(217, 136, 185)); 
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/pharm1.png"))); // NOI18N
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        try{
            ...
            ResultSet result = statement.executeQuery("select * from appUser where email='"+email+"' and password='"+password+"'");
            while(result.next()){
                temp = 1;
                if(result.getString("userRole").equals("Admin")){
                    ...
                    setVisible(false);
                    new PharmacistDashboard(email).setVisible(true);
